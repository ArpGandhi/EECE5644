...
fprintf('Empirical gamma = %.4f\n', emp_gamma);
fprintf('Minimum empirical P(error) = %.4f\n', Pe_min);
fprintf('At this gamma: TPR = %.4f, FPR = %.4f\n', TPR(idx_min), FPR(idx_min));
...
title('ROC Curve of Naive Bayesian Classifier', 'FontSize', 13);
legend('ROC Curve', 'Naive Bayesian Classifier', 'Min P(error) point', ...
